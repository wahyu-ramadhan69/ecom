                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                ?>
                                    <div class="col-xs-2">
                                        ...
                                        <?php
                                        $data = array('type' => 'number', 'class' => 'form-control', 'name' => 'qty', 'min' => '0', 'value' => '1', 'required' => 'true');
                                        echo form_input($data);
                                        ?>
                                    </div>
                                    <?php
                                    $data = array('type' => 'text', 'name' => 'satuan', 'value' => $row['satuan'], 'hidden' => 'true');
                                    echo form_input($data);
                                    ?>
                                    <input type="text" name="nama_file" value="<?php echo $row['nama_file']; ?>" hidden>
                                    <br>
