...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="<?php echo base_url(''); ?>">G0-VEGE</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('login'); ?>"><i class='fa fa-user'></i>hei</a>
                </li>
                <?php } else { ?>
                <li class="nav-item">
                <?php
                ...
                $data = $this->db->get();
                ?>
                    <li class="nav-item cta cta-colored"><a href="<?php echo base_url('keranjang'); ?>" class="nav-link"><span class="icon-shopping_cart"></span>[<?php echo $data->num_rows(); ?>]</a></li>
                </li>
