                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('asset/img/produk/') . $row['nama_file']; ?>" height="60" width="60" alt=""></td>
                                <td> Rp. <?php echo number_format($row['harga'], 2, ".", "."); ?> </td>
                                <td> <?php echo $row['qty']; ?> </td>
                                <td> <?php echo $row['satuan']; ?> </td>
                                <td> Rp. <?php echo number_format($row['total_harga'], 2, ".", "."); ?> </td>
                                <td width="4"> <a href="" class="badge badge-danger float-right" data-toggle="modal" data-target="#hapusmodal<?php echo $row['id']; ?>" title="Hapus Keranjang"><i class="fa fa-times"></i></a></td>
                            </tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Ingin Menghapus <b><?php echo $row['nama_produk']; ?> </b>dari keranjang?
                    </div>
