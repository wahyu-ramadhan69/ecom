    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          ...
          <a href="<?php echo base_url('admin/cetaklaporan'); ?>" class="btn btn-success">Cetak laporan</a>
          ...
          <div class="col-md-12">
            <div class="box box-danger box-solid">
              <div class="box-header">
                <h3 class="box-title">Daftar Penjualan Harian per <b><?php $new = date('d-m-Y', strtotime($today));
                                                                      echo $new; ?></b></h3>
              </div>
              <!-- /.box-header -->
