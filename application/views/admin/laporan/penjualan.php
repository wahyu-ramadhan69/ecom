            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php
                  $query = $this->db->get_where('transaksi', array('status' => 'Sedang di proses'));
                  echo $query->num_rows();
                  ?>
                </span>
              </div>
                    ...
                    foreach ($data as $row) : ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url('admin/penjualan/hapus/') . $row['id']; ?>" class="label label-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
