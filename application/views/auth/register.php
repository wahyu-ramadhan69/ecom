...
<body>
	<div class="signup-form">
		<form action="<?= base_url('register/prosesregister'); ?>" method="post" class="form-horizontal">
			<?php
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<input type="email" class="form-control" name="email" required="required" value="<?= set_value('email'); ?>">
				</div>
			</div>
			<div class=" form-group row">
		...
		<div class="text-center">Sudah punya akun ? <a href="<?php echo base_url('login'); ?>">Masuk ke akun</a></div>
	</div>
</body>
