...
<body>
    <div class="signup-form">
        <form action="<?= base_url('auth/forgot'); ?>" method="post" class="form-horizontal">
            <?php
            ...
            <div class="form-group row">
                <label class="col-form-label col-4">Masukkan email mu</label>
                <div class="col-8">
        ...
        <div class="text-center"><a href="<?php echo base_url('login'); ?>">Kembali ke Login</a></div>
    </div>
</body>
