...
<body>
    <div class="signup-form">
        <form action="<?= base_url('auth/ubahpass'); ?>" method="post" class="form-horizontal">
            <?php
            ...
            <div class="row">
                <div class="col-8 offset-4">
                    <h2>Ubah password untuk akun</h2>
                    <h7><?= $this->session->userdata('reset_email'); ?></h7>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-4">Password baru</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="password1" required="required">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-form-label col-4">Ulangi password baru</label>
                <div class="col-8">
                    <input type="text" class="form-control" name="password2" required="required">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-8 offset-4">
