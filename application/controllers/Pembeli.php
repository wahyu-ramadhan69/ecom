...
class Pembeli extends CI_Controller
{
	...
	{
		$this->load->view('pembeli/awal');
	}

	public function pesanan()
	{
		$session = array('user' => $this->session->userdata('username'));
		$data = $this->Pembeli_model->GetWhere('transaksi', $session);
	...
	{
		$produk = $this->Pembeli_model->load();
		$data = array('produk' => $produk);
		$this->load->view('pembeli/produk_page', $data);
	}
	...
	{
		$data = $this->Pembeli_model->GetWhere('user', array('email' => $this->session->userdata('username')));
		$data = array('data' => $data);
	...
	public function tambahkeranjang()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$session = $this->session->userdata('alamat');
	...
	public function prosespembayaran()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$slug = $this->input->post('metode_pembayaran');
			...
			$this->session->set_userdata('metode', $slug);
